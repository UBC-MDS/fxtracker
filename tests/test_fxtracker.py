...
def test_fx_rate_lookup():
    ...
    assert isinstance(pd.to_datetime(fx_rate_lookup('JPYHKD', 0.09)),
                      datetime.datetime), 'Return string should be a valid YYYY-MM-DD format'
...
def test_pl_trend_viz():
    ...
    assert isinstance(
        output, alt.vegalite.v4.api.Chart), "Altair chart object should be returned."

    output2 = pl_trend_viz("EURUSD", "2020-01-01", "2022-01-01", 'line')
    assert isinstance(
        output2, alt.vegalite.v4.api.Chart), "Altair chart object should be returned."
...
def test_price_trend_viz():
    ...
    assert isinstance(
        output_chart, alt.vegalite.v4.api.Chart), "Altair chart object should be returned."
